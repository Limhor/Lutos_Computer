...
<!-- Services -->
<!-- Team -->
<section class="bg-light page-section" id="team" style="margin-top: 5%;">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="img/team/photo_2020-01-17_09-49-18.jpg" alt="">
                    <h4>Tang Eamseng</h4>
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="img/team/DSC_0577.JPG" alt="">
                    <h4>Simhorn Limhor</h4>
                    <p class="text-muted">Coder</p>
                    <ul class="list-inline social-buttons">
                        <li class="list-inline-item">
                            <a href="#">
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="img/team/photo_2020-01-17_09-52-44.jpg" alt="">
                    <h4>Seang Siver</h4>
                    <p class="text-muted">Designer and coder</p>
                    <ul class="list-inline social-buttons">
                        <li class="list-inline-item">
                            <a href="#">
                                <i class="fab fa-twitter"></i>
