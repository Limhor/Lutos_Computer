...
<div style="height: 240vh;">
    <div class="container" style="height:70vh;">
        ...
        <div class="card" style="width: 18rem;" id="cards">
            <img class="card-img-top" src="{{asset('/uploads/laptopimage/' .$laptop->Laptop_images)}}"  alt="Laptop_images">
            <div class="card-body">
                <h5 class="card-title">{{ $laptop->Brand_Name }}</h5>
                <p class="card-text">Prices: {{ $laptop->Price }} $</p>
                <p class="card-text">Processor: {{ $laptop->Processor }} </p>
                <a href='{{ url("/singlelaptop/{$laptop->id}") }}' class="btn btn-primary">Go shop</a>
            </div>
        </div>
        @endforeach
            @foreach($laptops as $laptop)
