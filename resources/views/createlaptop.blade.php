...
<div class="container" style="float: right ; ">
    <div class="row">
        <div class="col-mid-6">
            <form method="post" enctype="multipart/form-data" action="{{url('/insertlaptop')}}">
                {{csrf_field()}}
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="Laptop_images" class="form-control-file" id="exampleInputFile" aria-describedby="fileHelp">
                    </div>
                    <div>
                        <button type="submit" class="btn btn-primary">Submit</button>
                        <a href="{{url('/homelaptop')}}" class="btn btn-danger">Back</a>
                    </div>
                </fieldset>
            </form>
        </div>
