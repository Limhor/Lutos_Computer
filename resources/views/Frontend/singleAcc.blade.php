...
<center>
    <form action="{{ url('laptop', array($accessory->id)) }}" method="post" style="border-style: none; margin-top: 10%;">
        <h2><a href="/accesory" class="text-decoration-none">Accessory</a></h2>
        @csrf
        <div class="card a" style="max-width: 60%;">
            <div class="row no-gutters">
                <div class="col-md-5">
                    <img src="{{asset('/uploads/accessoryimage/' .$accessory->Image)}}" width="450px" height="450px" alt="Laptop_images">
                </div>
                <div class="col-md-5">
                    <div class="card-body float-right">
                        <div  class="card-text">
                            <h2><b>{{ $accessory->Brand_Name }}</b></h2>
                            <small class="text-warning">&#9733; &#9733; &#9733; &#9733; &#9734;</small>
                        </div>

                        <p class="card-text">Availability: <b>In Stock</b></p>
                        <div class="row">
                            <p class="lead">Model: {{$accessory->Model}}</p>
                        </div>
                        <div class="row">
                            <p class="lead">Brand_Name: {{$accessory->Brand_Name}}</p>
                        </div>
                        <div class="row">
                            <p class="lead">Price: {{$accessory->Price}}</p>
                        </div>
                        <div class="row">
                            <p class="lead">Type: {{$accessory->Type}}</p>
                        </div>
                    </div>
                </div>
            </div>
